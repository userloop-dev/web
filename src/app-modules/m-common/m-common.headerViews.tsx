...
interface M_CommonHeaderViews_Props extends React.HTMLAttributes<HTMLDivElement> {}

export const M_CommonHeaderViews = ({}: M_CommonHeaderViews_Props) => (
	<div className='flex-1 flex flex-col items-center justify-center text-center gap-4 bg-surface-light border border-border rounded-lg w-full h-full'>
		<div className='z-20 text-3xl text-text-dark font-normal leading-tight'>Views</div>
